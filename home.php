   ...
   <section class="home-category">
      ...
      <div class="box-container">
         ...
         <div class="box">
            ...
            <h3>fruits</h3>
            <p>Fresh and organic fruits for your daily health.</p>
         ...
         <div class="box">
            ...
            <h3>grocery</h3>
            <p>Daily essentials, grains, oils, and more.</p>
         ...
         <div class="box">
            ...
            <h3>dry fruits</h3>
            <p>Premium quality almonds, cashews, and walnuts.</p>
            <a href="category.php?category=dry fruits" class="btn">dry fruits</a>
         </div>

         <div class="box">
            <img src="images/cat-5.png" alt="">
            <h3>dairy</h3>
            <p>Fresh milk, cheese, butter, and curd.</p>
         ...
         <div class="box">
            ...
            <h3>snacks</h3>
            <p>Tasty chips, biscuits, and namkeen.</p>
         ...
         <div class="box">
            ...
            <h3>beverages</h3>
            <p>Juices, soft drinks, tea, and coffee.</p>
