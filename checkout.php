...
if(isset($_POST['order'])){
   ...
   $flat = filter_input(INPUT_POST, 'flat', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
   ...
   $pin_code = filter_input(INPUT_POST, 'pin_code', FILTER_SANITIZE_FULL_SPECIAL_CHARS);

   $address = trim(sprintf('flat no. %s %s %s %s %s - %s', $flat, $street, $city, $state, $country, $pin_code));
